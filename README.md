# JavaFX-Projects
A repository for projects done in Java using JavaFX library, currently contains two projects:
*  a Microscope project
...
is a presentation of polimorphism in Java, using different implementation for different geometric figures. Upon start of the programme, the canvas is filled with circles, rectangles and ovals. Then the areas of each type of figure are calculated. User can regenerate the canvas and get the areas for new figures every time. The programme allows to choose the figure for which it calculates the area.
